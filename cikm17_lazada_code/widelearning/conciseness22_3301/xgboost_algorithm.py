...
class XGBoostAlgo(object):
    ...
    def get_input_data(self, features, target_column, label):
        ...
        extra_feature_list = ["ct_ratio", "title_num_stopspecialwords", "desc_num_stopspecialwords", \
                              "title_ratio_digit", "title_ratio_mixed", "title_ratio_alpha", \
                              "title_ratio_redundancy", "title_ratio_stopwords"]
        ...
        if "title_ratio_digit" in features:
            df_input["title_ratio_digit"] = df_input["title_num_digit"] / df_input["title_num_words"]
        if "title_ratio_mixed" in features:
            df_input["title_ratio_mixed"] = df_input["title_num_mixed"] / df_input["title_num_words"]
        if "title_ratio_alpha" in features:
            df_input["title_ratio_alpha"] = df_input["title_num_alpha"] / df_input["title_num_words"]
        if "title_ratio_redundancy" in features:
            df_input["title_ratio_redundancy"] = df_input["title_alpha_redundancy"] / df_input["title_num_words"]
        if "title_ratio_stopwords" in features:
            df_input["title_ratio_stopwords"] = df_input["title_num_stopwords"] / df_input["title_num_words"]
...
if __name__ == '__main__':
    ...
    if flags[0]:
        ...
        features = feature_man.get_basic_features(is_clarity=False) + \
