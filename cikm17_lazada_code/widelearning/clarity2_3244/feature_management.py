...
class FeatureManagement(object):
    ...
    def get_statistics_features(self, mode, is_clarity=False):
        if is_clarity:
            ...
            if mode == 1:
                '''
                features_set_1 = ["desc_num_words"]
                features_set_2 = ["desc_alpha_redundancy", "desc_length_adjusted"]
                features_set_3 = ["desc_num_stopwords"]
                '''
            ...
            if mode == 0:
                ...
                features_set_5 = [] #"ct_sum"
                for feature in ["title_avg_sim_score_cat1", "title_max_sim_score_cat1", "ct_sum"]:
                ...
                features_set_6 = ["ratio_title_desc"]
                '''
                features_set_6.append("ratio_title_desc_delta_mean_cat1")
                features_set_6.append("ratio_title_desc_delta_max_cat1")
                '''
...
if __name__ == "__main__":
    ...
    print(len(feature_man.get_basic_features()))
    print(len(features))